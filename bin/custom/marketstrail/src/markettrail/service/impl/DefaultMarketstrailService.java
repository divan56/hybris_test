...
public class DefaultMarketstrailService implements MarketstrailService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMarketstrailService.class);
	...
	{
		return DefaultMarketstrailService.class.getResourceAsStream("/marketstrail/sap-hybris-platform.png");
	}
