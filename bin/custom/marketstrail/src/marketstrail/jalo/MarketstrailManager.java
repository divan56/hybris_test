...
/**
 * This is the extension manager of the Marketstrail extension.
 */
public class MarketstrailManager extends GeneratedMarketstrailManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MarketstrailManager.class);
	 ...
	 */
	public static MarketstrailManager getInstance()
	{
		return (MarketstrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MarketstrailConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketstrailManager() // NOPMD 
	{
		LOG.debug("constructor of MarketstrailManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MarketstrailManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MarketstrailManager called, current tenant: {}", getTenant().getTenantID());
	}
