...
/**
 * This is the extension manager of the Myownapp extension.
 */
public class MyownappManager extends GeneratedMyownappManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MyownappManager.class);
	 ...
	 */
	public static MyownappManager getInstance()
	{
		return (MyownappManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MyownappConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyownappManager() // NOPMD 
	{
		LOG.debug("constructor of MyownappManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MyownappManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MyownappManager called, current tenant: {}", getTenant().getTenantID());
	}
