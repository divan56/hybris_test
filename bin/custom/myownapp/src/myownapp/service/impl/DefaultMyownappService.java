...
public class DefaultMyownappService implements MyownappService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMyownappService.class);
	...
	{
		return DefaultMyownappService.class.getResourceAsStream("/myownapp/sap-hybris-platform.png");
	}
